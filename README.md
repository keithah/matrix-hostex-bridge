...
- **Webhook Handler** (`pkg/webhook/`): Webhook endpoint implementation (untested)
...
- **HTTP endpoints**: Basic webhook endpoint implementation (untested)
...
│   └── webhook/handler.go         # Webhook handler (untested)
